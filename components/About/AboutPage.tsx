...
const AboutPage = () => {
  ...
  return (
    <>
      ...
      <p className="text-md mb-4 text-justify">
        ExploreWeb3 platform is not just another regular solana project directory
        ...
        features and solutions that ExploreWeb3 aim to offer the existing Solana
      ...
      {/* <div className="my-6">
        ...
        <ol>
          ...
          <li>
            ...
            <span>
              {" "}
              Contribute to the platform and earn rewards.
            </span>
          </li>
          <li>
            <label className="text-l font-bold my-6 text-purple-300">
      ...
      {/* <div className="my-6">
        ...
        <p>
          ExploreWeb3 is not only about Solana projects discovery and engagement
        ...
        <ol>
          <li>
            ...
            <span> Earn for approved project submissions.</span>
          </li>
          <li>
            <label className="text-l font-bold my-6 text-purple-400">
          ...
          <li>
            ...
            <span>
              {" "}
              Earn by referring others to subscribe to the ExploreWeb3 "S"
              Newsletter.
            </span>
          </li>
          <li>
