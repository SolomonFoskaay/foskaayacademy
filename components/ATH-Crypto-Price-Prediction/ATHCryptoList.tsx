...
export const cryptoSymbols = [
    ...
    'CKB', 'KAVA', 'KSM', 'GIGA', 'SAFE', 'CTC', 'TFUEL', 'SUSHI', 'TWT', 'BOME', 
  ...
  export const cryptoNames = [
    ...
    'Nervos Network', 'Kava', 'Kusama', 'Gigachad', 'Safe', 'Creditcoin', 'Theta Fuel', 'SushiSwap', 'Trust Wallet Token', 'Book Of Meme', 
