...
export const cryptoSymbols = [
    ...
    'LTC', 'NEAR', 'APT', 'ICP', 'MATIC', 'ETC', 'CRO', 'RENDER', 'TAO', 'VET', 
    'KAS', 'FET', 'ARB', 'AAVE', 'MINA', 'FIL', 'BGB', 'ALGO', 'OM', 'ATOM', 
  ...
  export const cryptoNames = [
    ...
    'Kaspa', 'Artificial SuperInterlligience Alliance', 'Arbitrum', 'Aave', 'Mina', 'Filecoin', 'Bitget Token', 'Algorand', 'Mantra', 'Cosmos', 
