// /components/donor/ATH-Crypto-Price-Prediction/Listings/FullDetailsPage/FoskaayFibGradeDisplay.tsx
...
const DonorFoskaayFibGradeDisplay: React.FC<FoskaayFibGradeDisplayProps> = ({ symbol, grade, currentPrice }) => {
    return (
...
export default DonorFoskaayFibGradeDisplay;