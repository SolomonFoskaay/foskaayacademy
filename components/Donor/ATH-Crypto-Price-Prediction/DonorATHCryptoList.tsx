...
export const cryptoSymbols = [
    ...
    'LTC', 'NEAR', 'APT', 'ICP', 'MATIC', 'ETC', 'CRO', 'AXL', 'TAO', 'VET', 
    'KAS', 'FET', 'RON', 'AAVE', 'MINA', 'FIL', 'LPT', 'ALGO', 'OM', 'ATOM', 
    'OKB', 'STX', 'XMR', 'FTM', 'WIF', 'BONK', "TIA", 'IMX', 'OP', 'DEXE', 
    'INJ', 'GRT', 'FLOKI', 'THETA', 'SEI', 'WLD', 'RUNE', 'ONDO', 'JASMY', 'GALA', 
    ...
    'CKB', 'KAVA', 'KSM', 'TRAC', 'SAFE', 'CTC', 'TFUEL', 'SUSHI', 'TWT', 'BOME', 
    'ASTR', 'DASH', 'HOT', 'PAXG', 'ENJ', 'PRIME', 'ZIL', 'WOO', 'ZRX', 'GMT', 
    'JTO', 'EIGEN', 'ZEN', 'JST', 'SATS', 'CELO', 'GLM', 'ONE', 'ANKR', 'WEMIX', 
    'ELF', 'ETHW', 'IOTX', 'SFP', 'ZETA', 'MANTA', 'MX', 'ARKM', 'QTUM',
  ];

  export const cryptoNames = [
    'Bitcoin', 'Ethereum', 'Ripple', 'Solana', 'Binance', 'Dogecoin', 'Cardano', 'Tron', 'Avalanche', 'Shiba Inu', 
    'Toncoin', 'Chainlink', 'Polkadot', 'Stellar Lumen', 'Bitcoin Cash', 'Sui', 'Pepe', 'Hedera', 'Uniswap', 'Super', 
    'Litecoin', 'Near Protocol', 'Aptos', 'Internet Computer', 'Polygon (POL ex-MATIC)', 'Ethereum Classic', 'Cronos', 'Axelar', 'Bittensor', 'VeChain', 
    'Kaspa', 'Artificial SuperInterlligience Alliance', 'Ronin', 'Aave', 'Mina', 'Filecoin', 'Livepeer', 'Algorand', 'Mantra', 'Cosmos', 
    'OKEx Ecosystem', 'Stacks', 'Monero', 'Fantom', 'DogWifHat', 'Bonk', "Celestia", 'Immutable', 'Optimism', 'DeXe Protocol', 
    'Injective', 'The Graph', 'Floki Inu', 'Theta Network', 'Sei', 'Worldcoin', 'Thorchain', 'Ondo', 'JasmyCoin', 'GalaChain', 
    'The Sandbox', 'Maker', 'Lido DAO', 'EOS', 'Quant', 'Brett (Based)', 'Beam', 'Kaia', 'KuCoin Token', 'Pyth Network', 
    ...
    'Nervos Network', 'Kava', 'Kusama', 'OriginTrail', 'Safe', 'Creditcoin', 'Theta Fuel', 'SushiSwap', 'Trust Wallet Token', 'Book Of Meme', 
    ...
    'Aelf', 'EthereumPoW', 'IoTeX', 'SafePal', 'ZetaChain', 'Manta Network', 'MX Token', 'Arkham', 'Qtum',
  ];